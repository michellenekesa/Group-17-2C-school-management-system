    ...
    <div id="data" class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <td style="text-align: left;
                  padding: 8px;"><a href="<?php echo e(url('delete_resource',$resources->id)); ?>" class="btn btn-primary px-4 mx-auto mb-4" onclick="return confirm('Are You Sure You Want To Delete This Resource ?')">Delete Resource</a></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </table>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form action="<?php echo e(url('add_resource')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                ...
                <br>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form action="<?php echo e(url('send_message')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <input type="text" class="form-control border-0 p-4" placeholder="Name" required="required" name="name" id="name"/>
                                </div>
...
</html><?php /**PATH C:\Users\User\Downloads\Student_System\resources\views/lecturer/home.blade.php ENDPATH**/ ?>