                ...
                <div class="col-lg-12">
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form action="{{ url('reg_course') }}" method="post" enctype="multipart/form-data">
          @csrf
                ...
                <br>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form action="{{ url('reg_grad') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                 <div class="form-group">
                                    <input type="text" class="form-control border-0 p-4" placeholder="Student ID" required="required" name="uid" id="uid"/>
                                </div>
